                ...
                <header className="header-home">
                 ...
                 <main> 
                    <div className={`box ${isBoxVisible ? "" : "hidden"}`}>
                       <p>Thanks for your interest in Inner Engineering!</p><p>This is the Beta version so we are not yet allowing users to sign-up. Please explore around, play with the forms, and check back soon!</p>
